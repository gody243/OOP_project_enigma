...
public  class Questions extends Solutions 
{
    ...
    private void hardQ()
    {
        ...
        questions.put(22,"This enigma would had been proposed by Albert Einstein.\nAccording to him,\nonly 2% of the population would be able to solve this enigma.\n5 people of different nationalities:"
            +"\nlive 5 houses lined up of distinct colors"
            +"\nsmoke cigars of different brands\n(Rothman,Dunhill,Prince,Pall Mall,Blue Master)"
            +"\ndrink 5 differents drinks\n(tea,milk,beer,water,coffee)"
        ...
        questions.put(24,"A wheat bag weighs the three quarters of a barley bag\nwhich weighs 2kg more than a wheat bag.\nWhat is the weight of a wheat bag ?");
        questions.put(25,"A man meets his neighbor and\nlearns that she's got 3 daughters.\nIntrigued,he asks their ages,\nbut she wanted to answer indirectly with this riddle :\nNeighbor:The product of their ages is 36."
            +"\nMan:I would need more information\nN:The sum is equal to the house number facing us.\nM:I still cannot find it.\nThe oldest is blond\nOh alright I see.\nHow old is the oldest ?");
        questions.put(26,"Christelle needs someone to paint her wall,\nshe knows 3 people who could do it.\nFranck can paint a wall in 1 hour,"
