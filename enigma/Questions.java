...
public class Questions extends Solutions {
    protected static Map<Integer, String> question= new LinkedHashMap<>();
    ...
    private void easyQ() {
        ...
        question.put(2, "What's the following letter:\nJ-F-M-A-M-J-J-?");
        question.put(3,
        ...
        question.put(10, "How many animals of each species did\nMoses take with him on his arck ?");
    ...
    private void mediumQ() {
        ...
        question.put(12, "What walks on four legs in the morning,\ntwo in the afternoon and three at night?");
        question.put(13, "Find what seems to be the logical result :\n1\n1 1\n2 1\n1 2 1 1\n1 1 1 2 2 1\n3 1 2 2 1 1");
        question.put(14, "Find the missing number :\n14 25 53 44 67\n74 63 ?? 44 21");
        question.put(15, "3 cats catch 3 mice in 3 minutes.\nHow many do you need to catch 60 mice in 60 minutes?");
        question.put(16, "2=6\n3=36\n4=436\n5=5436\n6=?");
        question.put(17, "What belongs to me \nbut that others use more than me ?");
        question.put(18,
                "A man is looking at a portrait.\nSomeone asks him: \nWho are you looking at?,he says:\nI have no brother or sister,\nbut this man's father is my father's son.\nWho is on that portrait?");
        question.put(19, "Find the missing part of the following:\t1j-2f-3m-4a-5m-6j-7j-8a-'?'-10o-11n-12d");
        question.put(20,
    ...
    private void hardQ() {
        ...
        question.put(21, "What number divided by itself gives its double?");
        question.put(22,
        ...
        question.put(27, "I am between 188 and 189,\nbut I am not 189.\nWho am I ?");
        question.put(28, "When I dry,I get wet.\nWho am I ?");
        question.put(29, "It has got teeth but does Not bite,\nWhat is it ?");
        question.put(30,
